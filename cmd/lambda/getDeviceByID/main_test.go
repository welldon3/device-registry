...
func (m *mockSvc) GetDeviceByID(_ context.Context, _ string) (*model.Device, error) {
...
func TestHandle_200_Found(t *testing.T) {
	setup(t, &mockSvc{device: &model.Device{DeviceID: "id1", Name: "r", Type: "net"}})
